import {
  ...
  const Lab5bai3 = ({navigation}) => {
    ...
    const [image, setimage] = useState(require('../../image/heart.png'));
    const handleGetStartedPress = () => {
      navigation.navigate('Lab5bai1');
    };
    const backVe = () => {
      navigation.goBack();
    };
    const doianhheart = () => {
      if (liked) {
        ...
        setLiked(false);
        setimage(require('../../image/heart.png'));
      } else {
        Alert.alert('Thông báo', 'Đã bỏ thích ảnh');
        setLiked(true);
        setimage(require('../../image/like.png'));
      }
    };
    const tripInfo =
    ...
    return (
      <View style={styles.container}>
        ...
        <ImageBackground
          style={styles.image}
          source={require('../../image/phoco.jpg')}
          resizeMode="cover">
          <View style={styles.header}>
            <View style={styles.iconcontai}>
              ...
              <Image
                source={require('../../image/3cham.png')}
                style={styles.icon}
              />
            </View>
